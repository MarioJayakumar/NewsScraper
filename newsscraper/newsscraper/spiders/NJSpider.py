...
class NJSpider(GenericNewsSpider):

    def __init__(self, **kwargs):
        self.name = "NJ"
        self.starturl = "https://www.nj.com/"
        self.doNotScrape = [r"https://www\.nj\.com/archives/.*", r"https://www\.nj\.com/sports/.*"]
    ...
    def get_response_publication_date(self, response):
        timeblock = response.css('span.dateline__published')[0]
